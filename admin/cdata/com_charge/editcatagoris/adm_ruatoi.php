...
if ($action == 'edit') {
    ...
    $pk_zen_vpoint = $_POST['pk_zen_vpoint'];
    $content .= "\$pk_zen_vpoint	= $pk_zen_vpoint;\n";
    $pk_zen = $_POST['pk_zen'];
    $content .= "\$pk_zen	= $pk_zen;\n";
    $pk_vpoint = $_POST['pk_vpoint'];
    $content .= "\$pk_vpoint	= $pk_vpoint;\n";
    ...
    <div class="table">
        ...
        <form id="editconfig" name="editconfig" method="post" action="">
            ...
            <table width="100%" border="0" bgcolor="#9999FF">
                ...
                <tr bgcolor="#FFFFFF">
                    <td>
                        <div align="center">Giết <= <input type="text" name="pk_zen_vpoint"
                                                           value="<?php echo $pk_zen_vpoint; ?>" size="2"/> mạng
                        </div>
                    </td>
                    <td>
                        <div align="center"><input type="text" name="pk_zen" value="<?php echo $pk_zen; ?>" size="10"/>
                            Zen/mạng
                        </div>
                    </td>
                </tr>
                <tr bgcolor="#FFFFFF">
                    <td>
                        <div align="center">Giết > <?php echo $pk_zen_vpoint; ?> mạng</div>
                    </td>
                    <td>
                        <div align="center"><input type="text" name="pk_vpoint" value="<?php echo $pk_vpoint; ?>"
                                                   size="2"/> V.Point/mạng
                        </div>
                    </td>
                </tr>
