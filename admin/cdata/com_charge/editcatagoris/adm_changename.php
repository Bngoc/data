<?php
$file_edit = 'config/config_changename.php';
...
if ($action == 'edit') {
    ...
    $changename_vpoint = $_POST['changename_vpoint'];
    $content .= "\$changename_vpoint	= $changename_vpoint;\n";
...
<div id="center-column">
    ...
    <div class="table">
        ...
        <form id="editconfig" name="editconfig" method="post" action="">
            ...
            <center>Chi phí Đổi Tên : <input type="text" name="changename_vpoint"
                                             value="<?php echo $changename_vpoint; ?>" size="5"/> Vpoint<br>
