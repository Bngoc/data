...
if ($action == 'edit') {
    ...
    $taypoint_vpoint = $_POST['taypoint_vpoint'];
    $content .= "\$taypoint_vpoint	= $taypoint_vpoint;\n";
...
<div id="center-column">
    ...
    <div class="table">
        ...
        <form id="editconfig" name="editconfig" method="post" action="">
            ...
            <center>Chi phí Tẩy Tủy : <input type="text" name="taypoint_vpoint" value="<?php echo $taypoint_vpoint; ?>"
                                             size="5"/> Vpoint<br>
