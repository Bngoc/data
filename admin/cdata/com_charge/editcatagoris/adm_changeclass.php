...
if ($action == 'edit') {
    ...
    $changeclass_vpoint = $_POST['changeclass_vpoint'];
    $content .= "\$changeclass_vpoint	= $changeclass_vpoint;\n";
    $changeclass_trureset = $_POST['changeclass_trureset'];
    $content .= "\$changeclass_trureset	= $changeclass_trureset;\n";
    $changeclass_resetmin = $_POST['changeclass_resetmin'];
    $content .= "\$changeclass_resetmin	= $changeclass_resetmin;\n";
        ...
        <form id="editconfig" name="editconfig" method="post" action="">
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="changeclass_vpoint" value="<?php echo $changeclass_vpoint; ?>"
                               size="5"/> vpoint
                    </td>
                </tr>
                <tr>
                    <td>Trừ Reset:</td>
                    <td><input type="text" name="changeclass_trureset" value="<?php echo $changeclass_trureset; ?>"
                               size="5"/> %
                    </td>
                </tr>
                <tr>
                    <td>Điều kiện được phép Đổi Giới Tính:</td>
                    <td>Reset >= <input type="text" name="changeclass_resetmin"
                                        value="<?php echo $changeclass_resetmin; ?>" size="5"/></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="center"><input type="submit" name="Submit"
                                              value="Sửa" <?php if ($accept == '0') { ?> disabled="disabled" <?php } ?> />
                    </td>
                </tr>
            </table>
        </form>
