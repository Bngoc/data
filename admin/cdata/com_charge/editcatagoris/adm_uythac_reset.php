        ...
        <form id="editconfig" name="editconfig" method="post" action="">
            ...
            <table width="100%" border="0" bgcolor="#9999FF">
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_1"
                                              value="<?php echo $point_uythac_rs_cap_1; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_2"
                                              value="<?php echo $point_uythac_rs_cap_2; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_3"
                                              value="<?php echo $point_uythac_rs_cap_3; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_4"
                                              value="<?php echo $point_uythac_rs_cap_4; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_5"
                                              value="<?php echo $point_uythac_rs_cap_5; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_6"
                                              value="<?php echo $point_uythac_rs_cap_6; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_7"
                                              value="<?php echo $point_uythac_rs_cap_7; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_8"
                                              value="<?php echo $point_uythac_rs_cap_8; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_9"
                                              value="<?php echo $point_uythac_rs_cap_9; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_10"
                                              value="<?php echo $point_uythac_rs_cap_10; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_11"
                                              value="<?php echo $point_uythac_rs_cap_11; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_12"
                                              value="<?php echo $point_uythac_rs_cap_12; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_13"
                                              value="<?php echo $point_uythac_rs_cap_13; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_14"
                                              value="<?php echo $point_uythac_rs_cap_14; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_15"
                                              value="<?php echo $point_uythac_rs_cap_15; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_16"
                                              value="<?php echo $point_uythac_rs_cap_16; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_17"
                                              value="<?php echo $point_uythac_rs_cap_17; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_18"
                                              value="<?php echo $point_uythac_rs_cap_1; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_19"
                                              value="<?php echo $point_uythac_rs_cap_19; ?>" size="1"/></td>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><input type="text" name="point_uythac_rs_cap_20"
                                              value="<?php echo $point_uythac_rs_cap_20; ?>" size="1"/></td>
