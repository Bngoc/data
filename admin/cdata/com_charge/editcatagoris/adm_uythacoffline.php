...
if ($action == 'edit') {
    ...
    $phut_1point = $_POST['phut_1point'];
    $content .= "\$phut_1point	= $phut_1point;\n";
    $uythacoff_price = $_POST['uythacoff_price'];
    $content .= "\$uythacoff_price	= $uythacoff_price;\n";
        ...
        <form id="editconfig" name="editconfig" method="post" action="">
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="phut_1point" value="<?php echo $phut_1point; ?>" size="5"/> Phút Ủy
                        thác Offline sẽ nhận được 1 điểm Ủy thác
                    </td>
                </tr>
                <tr>
                    <td>Chi phí:</td>
                    <td><input type="text" name="uythacoff_price" value="<?php echo $uythacoff_price; ?>" size="5"/>
                        Vpoint / 1 phút Ủy Thác Offline
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
