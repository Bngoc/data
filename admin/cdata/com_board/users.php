...
<ul class="sysconf_top">
    ...
    <li<?php if ($section == 0) echo ' class="selected"'; ?>><a
...
<div style="text-align: right; margin: 16px 0 0 0;"><a class="external"
                                                       onclick="<?php echo cn_snippet_open_win(PHP_SELF . '?mod=help&section=users'); ?>"
                                                       href="#">Understanding user levels</a></div>
