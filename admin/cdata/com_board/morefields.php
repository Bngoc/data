...
<table class="std-table" width="100%">
    ...
    <?php if ($list) foreach ($list as $_name => $item) { ?>
        <tr <?php if ($name == $_name) echo 'class="row_selected"'; ?>>
            <td align="center"><a
                    href="<?php echo cn_url_modify("extr_name=$_name"); ?>"><?php echo cn_htmlspecialchars($_name); ?></a>
            </td>
...
<form action="<?php echo PHP_SELF; ?>" method="POST">
    ...
    <table class="panel">
        ...
        <tr>
            ...
            <td><input type="text" style="width: 250px;" name="name" value="<?php echo cn_htmlspecialchars($name); ?>"/>
            </td>
        </tr>
        <tr>
            <td align="right">Group</td>
            <td style="color: #666;"><input style="width: 250px;" type="text" name="group"
                                            value="<?php echo cn_htmlspecialchars($group); ?>"/>
                <br/>Grouping allows you to group fields in different blocks
            </td>
        </tr>
        <tr>
            <td align="right">Description</td>
            <td><input style="width: 675px;" type="text" name="desc" value="<?php echo cn_htmlspecialchars($desc); ?>"/>
            </td>
        </tr>
        <tr>
            <td align="right">Meta</td>
            <td style="color: #666;"><input style="width: 675px;" type="text" name="meta"
                                            value="<?php echo cn_htmlspecialchars($meta); ?>"/>
                <br/>Meta used by SELECT box, enter value1;value2;...;valueN
            </td>
        </tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td><input type="submit" value="Add/Replace field"/></td>
        </tr>
