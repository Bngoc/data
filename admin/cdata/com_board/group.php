...
<form action="<?php echo PHP_SELF; ?>" method="POST">
    ...
    <table class="panel">
        ...
        <tr>
            <td align="right"><input type="checkbox" name="master_box" onclick="check_uncheck_all('acl[]');" value="Y"/>
            </td>
                ...
                <td>
                    <?php foreach ($cons as $name => $desc) { ?>
                        <span style="float: left; width: 200px;">
                            <input title="<?php echo $name; ?>" type="checkbox" name="acl[]" <?php if ($desc['c']) {
                                echo 'checked';
                            } ?> value="<?php echo $name; ?>"/>
                            <?php
                            if ($desc['t']) {
        ...
        <tr>
            ...
            <td>
                <div style="float:left;">
                    ...
                    <?php if ($group_id && ($group_id != 1 && $group_id != 5)) { ?><input type="submit"
                                                                                          onclick="setMode('edit');"
                                                                                          value="Edit group"/>&nbsp;<?php } ?>
