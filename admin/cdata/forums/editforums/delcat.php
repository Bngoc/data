    ...
    <div id="center-column" class="middle">
        <div class="content left_forums">
            <div class="col_1 tab2">
				...
				<select style="width:150px" id="mySelect" name="" class="ccmuc" onchange="()">
			...
			<form name="form1" method="post" action="">
				...
				<li>
				<?php /*
					$catsql1 = "SELECT * FROM topics WHERE forum_id=1";
					$catresult1 =$db->query($catsql1);
				...
				$limitrows=$db ->query("SELECT * FROM topics WHERE forum_id= 1 order by id asc limit " .$start . "," . $row_per_page . ";"); //bắt đầu lấy dữ liệu (^)_(^)
				//-- ------------------------------------------  -->
				if($numrows==0){
					echo"<font style='color:red'>Non-Object!</font>";
				}
...
<script type="text/javascript">
    function showUser(str) {
        ...
        xmlhttp.open("GET", "ad.php?id=" + str, true);
        xmlhttp.send();
    }
</script>
