...
<table class="spanned">
    ...
    <tr class="row">
        <td><a href="javascript:insertcode('link', prompt('Enter the complete URL of the hyperlink', 'http://') )">Insert
                Link</a></td>
    ...
    <tr>
        <td>
            <a href="javascript:insertcode('color', prompt('Enter color of the text (blue, red, green, fuchsia)', '') )">Text
                Color</a></td>
        <td>[color=<span>COLOR</span>]<span>Text</span>[/color]</td>
    </tr>

    <tr class="row">
        <td><a href="javascript:insertcode('size', prompt('Enter size of the text (in points format)',''))">Text
                Size</a></td>
    ...
    <tr>
        <td>
            <a href="javascript:insertcode('font', prompt('Enter font of the text (verdana, arial, times, courier)','') )">Text
                Font</a></td>
    ...
    <tr class="row">
        <td>
            <a href="javascript:insertcode('align', prompt('Enter align of the text (right, left, center, justify)','') )">Text
                Align</a></td>
