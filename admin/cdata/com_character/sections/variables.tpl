...
<div class="code" style='font-family: Verdana, Arial, Helvetica, sans-serif;'>&lt;?PHP<br><br>
    ...
    <b>$template = "&lt;NAME&gt;";</b>&nbsp;&nbsp;<i>// load another template, if you don't use it the default template
        will be loaded.</i><br>
    <b>$static = TRUE;</b>&nbsp;&nbsp;<i>// included news will not load on this location, for more info see 'Using
        Multiple Includes'.</i><br>
    <b>$category = "&lt;ID&gt;";</b>&nbsp;&nbsp;<i>// show only news from the selected category where &lt;ID&gt; is the
        id of category.</i><br>
    <b>$start_from = "&lt;NUMBER&gt;";</b>&nbsp;&nbsp;<i>// show the news starting not from the first newest but from
        &lt;NUMBER&gt;, it is required to use $start_from = "&lt;NUMBER&gt;";
