...
//session_start();
//echo "eeeeeeeee" .$_SERVER['DOCUMENT_ROOT'];
list($mod, $act) = GET('mod, act', 'GETPOST');

if (empty($mod)) $mod = 'editconfig';

//if(!isset($_SESSION['ADMIN']))
//Header('Location:' . $config_basedir . '/adminllllllllllll/2.php');
//else
//{
//echo $_SESSION['ADMIN'];
?>
...
<head>
    ...
    <script type="text/javascript" src="/forum/js/jquerys/bncustom.js"></script><!-- ham cho login -->
    <!--newsua ham -->
    ...
    <style>
        ...
        .wrapper div.hover {
            border-bottom: 1px dashed #80C0C0;
            padding: 3px 0 3px 0;
        }
        ...
        ul.sysconf_top li.selected {
            background: rgb(0, 167, 219);
        }

        ul.sysconf_top li.selected a {
            color: white;
        }
                ...
                <ul>
                    <?php if (isset($_SESSION['user'])) { ?>
                        <li class="lg-facebook">
                            <a href="<?php echo cn_url_modify("mod=personal"); ?>" class="">
                                <!--data-gps-track="profile_summary.click()">-->
                                <div class="gravatar" style="display: inline-block;"
                                     title="<?php echo $_SESSION['user'] ?>">
                                    <img src="https://graph.facebook.com/100006110288487/picture?type=large" alt=""
                                         width="24" height="24" class="avatar-me js-avatar-me"></div>
                            </a>
                            <div class="links-container" style="display: inline-block;">
                                <a href="<?php echo cn_url_modify('mod=logout', 'action=logout'); ?>" title="Logout"
                                   id='logout'>Logout</a>
                            </div>
                            ...
                            <div class="box_login showbox" style="display: none;">
                                <div class="box_login1">
                                    <div class="loginUser">
                                        ...
                                        <span><input type="text" name="loginUser" id="loginUser" value=""
                                                     placeholder="Username or Email"></span>
                                    </div>
                                    <div class="loginPass">
                                        <label>Mật khẩu</label>
                                        <span><input type="password" name="loginPass" id="loginPass" value=""
                                ...
                                <div style="text-align: center;clearfloat: both;padding-top: 10px;color:#c00"
                                     id="loginmessage"></div>
                                <div class="box_login2">
                                    <span class="line"></span>
                                    <span class="line1"></span>
                                    <span class="title">Hoặc</span>
                                    <a class="img_login-fb" href="#"><img border="0" title="login facebook"
                                                                          alt="login facebook"
                                                                          src="/forum/images/icon/img-facebook.png"></a>
                                </div>
                            </div>
                        </li>

                        <!------Login: Facebook------- -->
                        <li class="lg-facebook"><a rel="nofollow" href="#"><img border="0" title="login facebook"
                                                                                alt="login facebook"
                                                                                src="/forum/images/icon/login-fb.jpg"></a>
                        </li>
                    <?php } ?>
                </ul>
    ...
    <div class="span-26 chon">
        ...
        <div class="search">
                ...
                <ul>
                    <li>
                        ...
                        <div class="tugoiy" style="">
                            ...
                            <a title="Ă¡o sÆ¡ mi blue exchange" href="#" class="topKeyword_link">Ă¡o sÆ¡ mi blue
                                exchange (249)</a>
                            ...
                            <a title="quá»³nh bĂ¬nh phuong" href="#" class="topKeyword_link">quá»³nh bĂ¬nh phuong
                                (55)</a>
                            <a title="quáº§n kaki nam viá»‡t tiáº¿n" href="#" class="topKeyword_link">quáº§n kaki nam
                                viá»‡t tiáº¿n (51)</a>
                            <a title="ao the thao" href="#">ao the thao (122)</a>
                            <a title="GiĂ&nbsp;y Aldo quai chĂ©o" href="#" class="topKeyword_link">GiĂ&nbsp;y Aldo quai
                                chĂ©o (12)</a>
            ...
            <form class="searchbox" method="get" action="search.php">
                ...
                <div id="p_scents"><p class="iconsearch"><input type="text" class="" id="txtQuery" value="" name="q"
                                                                placeholder="Nhập từ khóa tìm kiếm"></p></div>
...
" placeholder="Nháº­p tĂªn thÆ°Æ¡ng hiá»‡u, mĂ£ hoáº·c Ä‘áº·c Ä‘iá»ƒm sáº£n pháº©m" class="ui-autocomplete-input" onclick="resetText()" onblur="checkText()">
        ...
        <div class="Share">
            ...
            <p>
                <a rel="nofollow" class="facebook"
                   onclick="window.open('http://www.facebook.com/share.php?u='+document.location,'_blank');"
                   style="cursor: pointer;" title="ÄÄƒng lĂªn Facebook"></a>
                <a rel="nofollow" class="twitter"
                   onclick="window.open('http://twitter.com/home?status='+document.location,'_blank');"
                   style="cursor: pointer;" title="ÄÄƒng lĂªn Twitter"> </a>
                <a rel="nofollow" class="googleplus"
                   onclick="window.open('https://plus.google.com/share?url='+document.location,'_blank');"
                   title="ÄÄƒng lĂªn googleplus"></a>
            </p>
        </div>
    </div>
    ...
    <div class="menu">
        <div id='cssmenu'>
            <ul class="nav-tabs">
                <li <?php echo($mod == "editconfig" ? 'class="active"' : '') ?>><a
                        href="<?php echo cn_url_modify(array('reset'), "mod=editconfig") ?>">Cấu Hình Chung</a></li>
                <li <?php echo($mod == "editcatagoris" ? 'class="active"' : '') ?> ><a
                        href="<?php echo cn_url_modify(array('reset'), "mod=editcatagoris") ?>">Catagoris </a></li>
                <li <?php echo($mod == "editforums" ? 'class="active"' : '') ?> ><a
                        href="<?php echo cn_url_modify(array('reset'), "mod=editforums") ?>">Forum </a></li>
                <li <?php echo($mod == "editnews" ? 'class="active"' : '') ?> ><a
                        href="<?php echo cn_url_modify(array('reset'), "mod=editnews") ?>">Newtopic </a></li>
                <li <?php echo($mod == "comments" ? 'class="active"' : '') ?> ><a
                        href="<?php echo cn_url_modify(array('reset'), "mod=comments") ?>">Comments </a></li>
                <li <?php echo($mod == "edituser" ? 'class="active"' : '') ?> ><a
                        href="<?php echo cn_url_modify(array('reset'), "mod=edituser") ?>">User </a></li>
            </ul>
        </div>
                    ...
                    <div class="tent">
                        ...
                        <?php if ($mod == "editconfig") { ?>
                            <div id="editconfig" class="fade">
                                ...
                                <ul class="nav">
                                    ...
                                    <li><a href="admin.php?mod=editconfig&amp;act=config_chucnang">Cấu hình Chức
                                            năng</a></li>
                                    <li><a href="admin.php?mod=editconfig&amp;act=config_domain">Tên miền chính
                                            WebSite</a></li>
                                    <li><a href="admin.php?mod=editconfig&amp;act=config_antiddos">Hệ thống chống
                                            DDOS</a></li>
                                    <li><a href="admin.php?mod=editconfig&amp;act=activepro">Kích hoạt Phiên Pro</a>
                                    </li>
                                    <li class="last"><a href="admin.php?mod=editconfig&amp;act=config_server">Cấu Hình
                                            Server</a></li>
                                </ul>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($mod == "editcatagoris") { ?>
                            <div id="editcatagoris" class="fade">
                                ...
                                <ul class="nav">
                                    ...
                                    <li>
                                        <a href="<?php echo cn_url_modify("mod=editcatagoris", "act=edit") ?>" <?php echo($act == "edit" ? 'class="bd"' : '') ?> >Edit
                                            cat</a></li>
                                    <li><a href="admin.php?mod=editcatagoris&act=delcat">Del cat</a></li>
                                    <li><a href="admin.php?mod=editcatagoris&act=delc">del cl</a></li>
                                    <li class="last"><a href="admin.php?mod=editcatagoris&act=">Cau hinh catagoris</a>
                                    </li>
                                </ul>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($mod == "editforums") { ?>
                            <div id="editforums" class="fade">
                                ...
                                <ul class="nav">
                                    ...
                                    <li>
                                        <a href="<?php echo cn_url_modify("mod=editforums", "act=edit") ?>" <?php echo($act == "edit" ? 'class="bd"' : '') ?> >Edit
                                            forums</a></li>
                        ...
                        <?php if ($mod == "editnews") { ?>
                            <div id="editnews" class="fade">
                                ...
                                <ul class="nav">
                                    <li>
                                        <a href="<?php echo cn_url_modify("mod=editnews", "act=add") ?>" <?php echo($act == "add" ? 'class="bd"' : '') ?> >Add
                                            newtopics</a></li>
                                    <li>
                                        <a href="<?php echo cn_url_modify("mod=editnews", "act=edit") ?>" <?php echo($act == "edit" ? 'class="bd"' : '') ?> >Edit
                                            newtopics</a></li>
                                    <li>
                                        <a href="<?php echo cn_url_modify("mod=editnews", "act=del") ?>" <?php echo($act == "del" ? 'class="bd"' : '') ?> >Del
                                            newtopics</a></li>
