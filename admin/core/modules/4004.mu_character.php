...
add_hook('index/invoke_module', '*character_invoke');

// =====================================================================================================================

function character_invoke()
{
    $dashboard = array
    (
        'character:claschar:Ciw' => 'Cấu hình Class',
        'character:sysconf:Csc' => 'Reset',
        'character:personal:Cp' => 'Reset Vip',
        'character:templates:Ct' => 'Giới hạn Reset',
        'character:category:Cc' => 'Hỗ trợ tân thủ',
        'character:intwiz:Ciw' => 'Relife',
        'character:media:Cmm' => 'Ủy thác Online',
        'character:userman:Cum' => 'Ủy thác Offline',
        'character:group:Cg' => 'Ủy thác - Reset',
        'character:backup:Cb' => 'Ủy thác - Reset Vip',
        'character:comments:Com' => 'Rửa tội',
        'character:archives:Ca' => 'Tẩy điểm',
        'character:ipban:Cbi' => 'Đổi giới tính',
        'character:morefields:Caf' => 'Chuyển nhân vật',
        'character:wreplace:Crw' => 'Thế hệ',
        'character:logs:Csl' => 'Thuê điểm',
        'character:widgets:Cwp' => 'Đổi tên nhân vật',
        'character:maint:Cmt' => 'Di chuyển Map',
        'character:locale:Clc' => 'Khóa trang bị',
        'character:script:Csr' => 'Reset Master Skill', // Csr
        'character:selfchfk:Cpc' => 'Làm nhiệm vụ 220',
        'character:selfcfhk:Cpc' => 'Làm nhiệm vụ cấp 1',
        'character:selfcfhk:Cpc' => 'Đổi điểm Phúc Duyên',
        'character:selfcjfhk:Cpc' => 'Xóa đồ nhân vật',
        'character:sejlfcfhk:Cpc' => 'Reset Point - Cộng lại điểm',
    );
    ...
    // Top level (dashboard)
    cn_bc_add('Character', cn_url_modify(array('reset'), 'mod=' . $mod));
    ...
    foreach ($dashboard as $id => $_t) {
        ...
        if ($dl == $mod && $do == $opt && function_exists("character_$opt")) {
            cn_bc_add($_t, cn_url_modify(array('reset'), 'mod=' . $mod, 'opt=' . $opt));
            die(call_user_func("character_$opt"));
        }
    }

    echoheader('-@com_character/style.css', "Cutenews dashboard");
    ...
    echo exec_tpl('com_character/general');
...
*/
    ...
    if (request_type('POST')) {
        ...
        //else
        {
           ...
           ///     echo "1271 ==>" . $s . "=> $f <br>";
            ...
            //echo "1275 ==>".$post_cfg['class_dw_1'] . "=>  <br>";
    ...
    // ----
    cn_assign('template_parts, all_templates, template_text, template, sub, can_delete, all_header_conf', $template_parts, $acv, $template_text, $template, $sub, $can_delete, $all_header_conf);
    echoheader('-@com_character/style.css', "Templates");
    echo exec_tpl('com_character/template');
    echofooter();
}
