...
function dashboard_invoke()
{
    $dashMoney = array
    (
        'money:buyzen:Bzen' => 'Mua Zen',
        'money:itemvp:It' => 'Item Vpoint',
        'money:buyitemvp:Ct' => 'Mua Item Vpoint',
        'money:transvp:Cc' => 'Chuyển Vpoint',
        'money:transvp2gc:Ciw' => 'Vpoint &rsaquo;&rsaquo;&rsaquo; Gcoin',
        'money:transgc2vp:Cum' => 'Gcoin &rsaquo;&rsaquo;&rsaquo; Vpoint',
        'money:transgc2wc:Cg' => 'Gcoin &rsaquo;&rsaquo;&rsaquo; Wcoin',
        'money:transgc2wcp:Cb' => 'Gcoin &rsaquo;&rsaquo;&rsaquo; WcoinP',
        'money:transgc2gob:Com' => 'Gcoin &rsaquo;&rsaquo;&rsaquo; GoblinCoin',
        'money:transcas2vp:Ca' => 'Cash &rsaquo;&rsaquo;&rsaquo; Vpoint',
        'money:transvp2cas:Cbi' => 'Vpoint &rsaquo;&rsaquo;&rsaquo; Cash',
        'money:transipbo2pcpo:Cbi' => 'IP Bouns Point &rsaquo;&rsaquo;&rsaquo; PC.Point',
    );

    // Call dashboard extend
    $dashMoney = hook('extend_dashboard', $dashMoney);
    ...
    // Request menu
    foreach ($dashMoney as $id => $_t) {
        list($dl, $do, $acl_module) = explode(':', $id);
        if (test($acl_module) && function_exists("bitcoin_$do")) {
    ...
    foreach ($dashMoney as $id => $_t) {
        ...
        if (test($acl_module) && $dl == $mod && $do == $opt && function_exists("bitcoin_$do")) {
            cn_bc_add($_t, cn_url_modify(array('reset'), 'mod=' . $mod, 'opt=' . $do));
            die(call_user_func("bitcoin_$do"));
        }
    }

    echoheader('-@com_money/style.css', "Money - Money");
    ...
    cn_assign('dashboard, username, greeting_message', $dashMoney, $member['user_Account'], $greeting_message);

    //echo exec_tpl('header');
    echo exec_tpl('com_money/general');
...
function bitcoin_buyzen (){

}
// =====================================================================================================================

function bitcoin_buyitemvp (){

}
// =====================================================================================================================

function bitcoin_transvp (){

}
// =====================================================================================================================

function bitcoin_transvp2gc (){

}
// =====================================================================================================================

function bitcoin_transgc2vp (){

}
// =====================================================================================================================

function bitcoin_transgc2wc (){

}
// =====================================================================================================================

function bitcoin_transgc2wcp (){

}
// =====================================================================================================================

function bitcoin_transgc2gob (){

}
// =====================================================================================================================

function bitcoin_transcas2vp (){

}

// =====================================================================================================================
function bitcoin_transvp2cas (){

}

// =====================================================================================================================
function bitcoin_transipbo2pcpo (){
