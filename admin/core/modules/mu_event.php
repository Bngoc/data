...
function dashboard_invoke()
{
    $dashboard = array
    (
        'event:sysconf:Csc' => 'Xổ số kiến thiết',
        'event:personal:Cp' => 'Huy chương',
        'event:templates:Ct' => 'Vé làng Santa',
        'event:category:Cc' => 'Chợ trực tuyến',
        'event:intwiz:Ciw' => 'Dự đoán Bóng đá',
        'event:media:Cmm' => 'Top Card',
        'event:userman:Cum' => 'Top Point',
        'event:group:Cg' => 'Top Reset',
        'event:backup:Cb' => 'Nhiệm vụ ngẫu nhiên',
    );
    ...
    echoheader('-@com_event/style.css', "Cutenews dashboard");
    ...
    echo exec_tpl('com_event/general');
