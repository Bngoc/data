...
<form name=login action="<?php echo PHP_SELF; ?>?register" method="post">
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="2"><input tabindex="1" autocomplete="on" type="text" name="captcha" style="width:134px"
                                   size="20"></td>
        </tr>
        ...
        <tr>
            <td width=85><a href="#" style="border-bottom: 1px dotted #000080;"
                    ...
                    code</a></td>
            <td colspan="2"><img src="<?php echo getOption('http_script_dir'); ?>/captcha.php?page=admin" id="captcha"
                                 alt="">
            </td>
        </tr>
