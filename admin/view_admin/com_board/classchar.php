...
<form action="<?php echo PHP_SELF; ?>" method="POST">
    ...
    <table class="std-table opt_table">
            ...
            <?php if ($set_arr) {
                foreach ($set_arr as $df => $fd) {
                    ...
                    <tr <?php if ($odd++ % 2) {
                        ...
                        <td align="center"><input readonly="readonly" value="<?php echo $fd['id_6_val']; ?>" size="5"/>
                        </td>
                    </tr>
                    <?php if ($fd['end']) {
                        echo '<tr><td colspan="6"><hr></td></tr>';
        ...
        <?php } elseif ($sub === "uythac_resetvip") { ?>
                        ...
                        <?php if ($gh_loai1) {
                            foreach ($gh_loai1 as $key => $val) {
                                ...
                                <tr <?php if ($odd++ % 2) {
                                    ...
                                    <td align="center">Reset tối đa <input type="text"
                                                                           name="config[<?php echo $key; ?>]"
                                                                           value="<?php echo $val['top_gh']; ?>"
                                                                           size="1"/>
                                        lần/ngày
                                    </td>
                                </tr>
                        ...
                        <?php if ($set_arr) {
                            foreach ($set_arr as $key => $val) {
                                ...
                                <tr <?php if ($odd++ % 2) {
                                    ...
                                    <td>
                                        <div align="center"><input type="number"
                                                                   name="config[<?php echo $val['id_1']; ?>]"
            ...
            <?php if ($set_arr) {
                foreach ($set_arr as $df => $fd) { ?>
                    <tr <?php if ($odd++ % 2) {
                        ...
                        <td align="center"><b>Cấp <?php echo ++$i; ?></b></td>
                        <td align="center"><input type="number" name="config[<?php echo $fd['id_1']; ?>]"
                                                  value="<?php echo $fd['id_1_val']; ?>" style="width:65px"/>&le; Reset
                            &le;<input
