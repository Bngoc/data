...
<form action="<?php echo PHP_SELF; ?>" method="POST">
    ...
    <div class="panel">
        ...
        <select name="snippet">
            <?php foreach ($__list as $id => $_t) {
                echo '<option ' . (($id == $__snippet) ? 'selected' : '') . '>' . cnHtmlSpecialChars($id) . '</option>';
            } ?>
        </select>
...
<p style="text-align: right;"><a href="#"
                                 onclick="<?php echo cn_snippet_open_win(cn_url_modify(array('reset'), 'mod=help', 'section=snippets')); ?>"
                                 class="external">Understanding snippets</a></p>
