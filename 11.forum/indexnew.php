	...
	<div class="menu">
		<div id='cssmenu'>
			...
			<ul>
					...
					<li><a href="admin.php?mod=editwebshop" name="tab3">Webshop</a></li>
					<li><a href="admin.php?mod=editnapthe" name="tab4">Nạp Thẻ</a></li>
				</ul>
		</div>
	...
	<div id="main">
		<div class="middle">
			...
			<div id="right-column">
				...
				<div class="box">Detectand eliminate viruses and Trojan horses, even new and unknown ones.Detect and eliminate viruses and Trojan horses, even new and </div></div></div>
		<div class="clsormiddler"> </div>
		</div>
	</div>
</div>
<!-- --------------------footer--------------------- -->
