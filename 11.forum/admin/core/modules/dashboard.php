...
function dashboard_category()
{
	...
	if(isset($category_id)) {$category_id = stripslashes($category_id);$category_id = mysqli_real_escape_string($db,$category_id);}
	if(isset($category_name)) {$category_name = stripslashes($category_name);$category_name = mysqli_real_escape_string($db,$category_name);}
	if(isset($category_memo)) {$category_memo = stripslashes($category_memo);$category_memo = mysqli_real_escape_string($db,$category_memo);}
	if(isset($category_icon)) {$category_icon = stripslashes($category_icon);$category_icon = mysqli_real_escape_string($db,$category_icon);}
	if(isset($category_parent)) {$category_parent = stripslashes($category_parent);$category_parent = mysqli_real_escape_string($db,$category_parent);}
	//if(isset($category_name)) {$category_name = stripslashes($category_name);$category_name = mysqli_real_escape_string($db,$category_name);}
	if(isset($category_description)) {$category_description = stripslashes($category_description);$category_description = mysqli_real_escape_string($db,$category_description);}
	//else $category_id =0;
        ...
        if(!empty($category_name))
        {
            ...
            {            
				...
				if(!empty($categories_call)){
					foreach ($categories_call as  $value){
						...
						print "F_dashbroad 729 name_forum=> ".$value['name_forum']."-------acl_forum->".$value['acl_forum']." <br>";
						if($is_duble) break;
					}           
				}
            ...
            if(!empty($category_id))
            {
                //--------------------------------------------------------------
					...
					print "F_dashbroad 770 name_forum=> $category_name <br>";
					print "F_dashbroad 770 memo_forum=> $category_memo <br>";
					print "F_dashbroad 770 icon_forum=> $category_icon <br>";
					print "F_dashbroad 770 acl_forum=> $cat_acl <br>";
					print "F_dashbroad 770 parent_forum=> $category_parent <br>";
            ...
            if(!$is_cancel)// || $is_edit || $is_delete)
            {
				...
				foreach ($categories_call as $id =>$hh){
					...
					print "F_dashbroad 661 bien categories: name_forum=>" . $_category_name ."<br>";
					print "F_dashbroad 661 bien categories: memo_forum=>" . $_category_memo ."<br>";
					print "F_dashbroad 661 bien categories: icon_forum=>" . $_category_icon."<br>";					
					print "F_dashbroad 661 bien categories: acl_forum=>" .  $_category_acl."<br>";
					print "F_dashbroad 661 bien categories: parent_forum=>" . $_category_parent."<br>";
					print "F_dashbroad 661 bien categories: level_forum=>" .  $_category_level."<br>";
					print "F_dashbroad 661 bien categories: ac_forum=>" .  $_category_ac."<br>";
...
if ($category_id){
	...
	if(array_key_exists($category_id,$categories_call)){echo "F_dashbroad 1004 -------------------- ok id---------------------- <br>";}
