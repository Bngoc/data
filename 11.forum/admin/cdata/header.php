...
<!-- -------------------------------------------- -->
<style>
.wrapper .greet { font-size: 14px; margin: 0 0 15px 0; }

.wrapper h3 { font-size: 17px; margin: 0 0 10px 0; }
.wrapper div.hover { border-bottom: 1px dashed #80C0C0; padding: 3px 0 3px 0; }

div.hover .left { clear: left; float: left; }
div.hover .rgt { text-align: right; }

.options .a { float: left; width: 96%;margin-left: 10px; height: 20px; border: 1px solid gray; }
.options .b { float: left; background: #0080FF; color: white; height: 16px;  text-align: center; padding: 2px; }
.c { margin: 20px 0 0 0; text-align: right; }
.required { color: red; }

h2 { font-size: 14px; margin: 20px 0 3px 0; }
.options { float: left; width: 100%; padding: 20px 0 10px 0px; border: 1px dashed #d0d0d0; }
.opt-item { float: left; height: 95px; width: 140px; padding: 10px 0; overflow: hidden; text-align: center }

ul.sysconf_top { margin: 4px 0 0 0; padding: 0; list-style-type: none; padding: 10px 10px 0 10px; float:left; }
ul.sysconf_top li { float: left; padding: 5px 15px; }
ul.sysconf_top li.selected { background: rgb(0, 167, 219);  }
ul.sysconf_top li.selected a { color: white;  }

.opt_table { margin: 0 0 0 0; width: 100%; }
.opt_table input { text-align: center; }
.opt_table .o_title { color: #202020; }
.opt_table .o_title sup { font-size: 11px; }
.opt_table .o_desc { padding: 4px 0 4px 0; color: #808080; }
.opt_table tr.o_heading { font-size: 16px; font-weight: bold; background: #FFF0C0; padding: 2px 4px; margin: 10px 0 0 0;  }
					...
					<?php if(isset($_SESSION['user'])){?>
						<li class="lg-facebook">
							<a href="<?php echo cn_url_modify("mod=personal" ); ?>" class="" > <!--data-gps-track="profile_summary.click()">--> 
								<div class="gravatar" style="display: inline-block;" title="<?php echo $_SESSION['user'] ?>">
								...
								<div class="links-container" style="display: inline-block;">
										<a href="<?php echo cn_url_modify('mod=logout','action=logout'); ?>" title="Logout" id='logout'>Logout</a>
								</div>
