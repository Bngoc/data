					...
					<tr valign="top">
						...
						<td style="background: #f8f8f8; border: 0; display: block;width:15%" id="browse_dates">
												...
												<?php if ($YS == $yc){
													...
													//while($rowm = $resultm ->fetch_assoc()){
														...
														<?php if ($mc == $MS){
															...
															<?php if(count($arraynumrecode)>0){ echo '<small>(' . $arraynumrecode[$fr]['numrecode'] . ')</small>'; } ?>
																</div>
															<?php }
															}
														}
							...
							<?php //if ($category) { ?>
								<br/>
								<table class="std-table" width="100%">
									<tr><th><nobr><a href="<?php echo cn_url_modify('mod=editnews', 'forum_filters'); ?>">All forums</a></nobr></th></tr>
									<tr>
										<td >
											<div>
							...
							<?php //if ($showed)
								...
								?>
									...
									<tr style="background: <?php echo ($i++%2? '#F7F6F4' : '#FFFFFF'); ?>" class="hover"  >
										...
										<td align="center"><?php if ($rowedit['can']) { ?><input name="selected_news[]" value="<?php echo $rowedit['topicid']; ?>" style="border:0;" type='checkbox'><?php } ?></td>
