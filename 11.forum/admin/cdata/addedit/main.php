        ...
        <div class="section">
            ...
            <?php if (getoption('category_style') == 'select') { ?>
                ...
                <select name="category">
					...
					?>
						<optgroup label="<?php echo str_repeat('&nbsp;&nbsp;&nbsp;', $cat_data['level_forum']). cn_htmlspecialchars($cat_data['name_forum']); ?>" style="font:bold;">
					<?php } else{ ?>
                        <option <?php if (in_array($catid, $vCategory)) { echo 'selected="selected"'; } ?> value="<?php echo $catid; ?>"><?php echo str_repeat('&nbsp;&nbsp;&nbsp;', $cat_data['level_forum']). cn_htmlspecialchars($cat_data['name_forum']); ?></option>
			<?php }}	?>
                </select>
