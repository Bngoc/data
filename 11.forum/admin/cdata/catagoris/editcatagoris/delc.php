		...
		//alert(url);
			...
			?>
				...
				<select class="form-control input-sm" onchange=" javascript: this.form.submit(); " name="dropdown">
					  ...
					  <option value="1" selected="@(Session["selectedValue"].ToString() == "1")">option 1</option>
					  <option value="2" selected="@(Session["selectedValue"].ToString() == "2")">option 2</option>
					  <option value="5" selected="@(Session["selectedValue"].ToString() == "5")">option 5</option>
					  <option value="6" selected="@(Session["selectedValue"].ToString() == "6")">option 6</option>
					  <option value="7" selected="@(Session["selectedValue"].ToString() == "7")">option 7</option>
				</select>
