...
if($action == 'edit')
{
	...
	$cap_relife_max = $_POST['cap_relife_max'];		$content .= "\$cap_relife_max	= $cap_relife_max;\n";
	
	$rl_reset_relife1 = $_POST['rl_reset_relife1'];		$content .= "\$rl_reset_relife1	= $rl_reset_relife1;\t";
	$rl_point_relife1 = $_POST['rl_point_relife1'];		$content .= "\$rl_point_relife1	= $rl_point_relife1;\t";
	$rl_ml_relife1 = $_POST['rl_ml_relife1'];		$content .= "\$rl_ml_relife1	= $rl_ml_relife1;\n";
	
	$rl_reset_relife2 = $_POST['rl_reset_relife2'];		$content .= "\$rl_reset_relife2	= $rl_reset_relife2;\t";
	$rl_point_relife2 = $_POST['rl_point_relife2'];		$content .= "\$rl_point_relife2	= $rl_point_relife2;\t";
	$rl_ml_relife2 = $_POST['rl_ml_relife2'];		$content .= "\$rl_ml_relife2	= $rl_ml_relife2;\n";
	
	$rl_reset_relife3 = $_POST['rl_reset_relife3'];		$content .= "\$rl_reset_relife3	= $rl_reset_relife3;\t";
	$rl_point_relife3 = $_POST['rl_point_relife3'];		$content .= "\$rl_point_relife3	= $rl_point_relife3;\t";
	$rl_ml_relife3 = $_POST['rl_ml_relife3'];		$content .= "\$rl_ml_relife3	= $rl_ml_relife3;\n";
	
	$rl_reset_relife4 = $_POST['rl_reset_relife4'];		$content .= "\$rl_reset_relife4	= $rl_reset_relife4;\t";
	$rl_point_relife4 = $_POST['rl_point_relife4'];		$content .= "\$rl_point_relife4	= $rl_point_relife4;\t";
	$rl_ml_relife4 = $_POST['rl_ml_relife4'];		$content .= "\$rl_ml_relife4	= $rl_ml_relife4;\n";
	
	$rl_reset_relife5 = $_POST['rl_reset_relife5'];		$content .= "\$rl_reset_relife5	= $rl_reset_relife5;\t";
	$rl_point_relife5 = $_POST['rl_point_relife5'];		$content .= "\$rl_point_relife5	= $rl_point_relife5;\t";
	$rl_ml_relife5 = $_POST['rl_ml_relife5'];		$content .= "\$rl_ml_relife5	= $rl_ml_relife5;\n";
	
	$rl_reset_relife6 = $_POST['rl_reset_relife6'];		$content .= "\$rl_reset_relife6	= $rl_reset_relife6;\t";
	$rl_point_relife6 = $_POST['rl_point_relife6'];		$content .= "\$rl_point_relife6	= $rl_point_relife6;\t";
	$rl_ml_relife6 = $_POST['rl_ml_relife6'];		$content .= "\$rl_ml_relife6	= $rl_ml_relife6;\n";
	
	$rl_reset_relife7 = $_POST['rl_reset_relife7'];		$content .= "\$rl_reset_relife7	= $rl_reset_relife7;\t";
	$rl_point_relife7 = $_POST['rl_point_relife7'];		$content .= "\$rl_point_relife7	= $rl_point_relife7;\t";
	$rl_ml_relife7 = $_POST['rl_ml_relife7'];		$content .= "\$rl_ml_relife7	= $rl_ml_relife7;\n";
	
	$rl_reset_relife8 = $_POST['rl_reset_relife8'];		$content .= "\$rl_reset_relife8	= $rl_reset_relife8;\t";
	$rl_point_relife8 = $_POST['rl_point_relife8'];		$content .= "\$rl_point_relife8	= $rl_point_relife8;\t";
	$rl_ml_relife8 = $_POST['rl_ml_relife8'];		$content .= "\$rl_ml_relife8	= $rl_ml_relife8;\n";
	
	$rl_reset_relife9 = $_POST['rl_reset_relife9'];		$content .= "\$rl_reset_relife9	= $rl_reset_relife9;\t";
	$rl_point_relife9 = $_POST['rl_point_relife9'];		$content .= "\$rl_point_relife9	= $rl_point_relife9;\t";
	$rl_ml_relife9 = $_POST['rl_ml_relife9'];		$content .= "\$rl_ml_relife9	= $rl_ml_relife9;\n";
	
	$rl_reset_relife10 = $_POST['rl_reset_relife10'];		$content .= "\$rl_reset_relife10	= $rl_reset_relife10;\t";
	$rl_point_relife10 = $_POST['rl_point_relife10'];		$content .= "\$rl_point_relife10	= $rl_point_relife10;\t";
	$rl_ml_relife10 = $_POST['rl_ml_relife10'];		$content .= "\$rl_ml_relife10	= $rl_ml_relife10;\n";
