<?php
$file_edit = 'config/config_taypoint.php';
...
if($action == 'edit')
{
	...
	$taypoint_vpoint 	= $_POST['taypoint_vpoint'];		$content .= "\$taypoint_vpoint	= $taypoint_vpoint;\n";
...
<?php if($notice) echo $notice; ?>
				...
				<center>Chi phí Tẩy Tủy : <input type="text" name="taypoint_vpoint" value="<?php echo $taypoint_vpoint; ?>" size="5"/> Vpoint<br>
