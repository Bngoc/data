...
<?php } ?>
<?php if( $mod=='Catagoris') { ?>
			<ul class="nav">
				<li><a href="admin.php?mod=Catagoris&act=addcat">Add Cat</a></li>
				<li><a href="admin.php?mod=Catagoris&act=editcat">Edit cat</a></li>
				<li><a href="admin.php?mod=Catagoris&act=delcat">Del cat</a></li>
