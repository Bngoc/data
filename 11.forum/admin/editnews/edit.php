...
//echo ": " . SERVDIR. "/forum/config.php";
//echo "config_basedir: " . $config_basedir . "<br>";
  // echo "config_forumsname: " . $config_forumsname . "<br>";
   //echo "DB: " . $db . "<br>";
 //exit();
...
// ----------------------------------------------------
	...
	cn_assign('$sqlyear, $sqlyearmon, $sqlyearmonday, $sqlordershow, pagination db', $myy, $myym, $myymd, $ordershow, $pagination, $db);
    
	echo exec_tpl('cdata/edit_new');
    // ----------------------------------------------------
}