...
class vietvbbTopx
{
    ...
    private function getTabInfo($num)
    {
        ...
        switch ($this->vbb->options['vietvbbtopstats_switch_t' . $num]) {
            case 0:
                ...
                break;
            case 1:
                $tab['title'] = $vbphrase['latest_news'];
                $tab['id'] = 'latest_news';
                break;
            case 2:
                $tab['title'] = $vbphrase['newest_members'];
                $tab['id'] = 'newest_members';
                break;
            case 3:
                $tab['title'] = $vbphrase['top_posters'];
                $tab['id'] = 'top_posters';
                break;
            case 4:
                $tab['title'] = $vbphrase['top_starters'];
                $tab['id'] = 'top_starters';
                break;
            case 5:
                $tab['title'] = $vbphrase['top_referrers'];
                $tab['id'] = 'top_referrers';
                break;
            case 6:
                $tab['title'] = $vbphrase['most_viewed'];
                $tab['id'] = 'most_viewed';
                break;
            case 7:
                $tab['title'] = $vbphrase['hottest_threads'];
                $tab['id'] = 'hottest_threads';
                break;
            case 8:
                $tab['title'] = $vbphrase['top_reputation'];
                $tab['id'] = 'top_reputation';
                break;
            case 9:
                $tab['title'] = $vbphrase['thanked_members'];
                $tab['id'] = 'thanked_members';
                break;
            case 10:
                $tab['title'] = $vbphrase['top_forums'];
                $tab['id'] = 'top_forums';
                break;
            case 11:
                $tab['title'] = $vbphrase['top_infractions'];
                $tab['id'] = 'top_infractions';
                break;
            case 12:
                $tab['title'] = $vbphrase['latest_classads'];
                $tab['id'] = 'latest_classads';
                break;
            case 14:
                $tab['title'] = $vbphrase['top_credits'];
                $tab['id'] = 'top_credits';
                break;
            case 15:
                $tab['title'] = $vbphrase['latest_posts'];
                $tab['id'] = 'latest_posts';
                break;
            case 16:
                $tab['title'] = $this->vbb->options['vietvbbtopstats_latest_posts_custom1_name'];
                $tab['id'] = 'latest_posts_custom1';
                break;
            case 17:
                $tab['title'] = $this->vbb->options['vietvbbtopstats_latest_posts_custom2_name'];
                $tab['id'] = 'latest_posts_custom2';
                break;
            case 18:
                $tab['title'] = $this->vbb->options['vietvbbtopstats_latest_posts_custom3_name'];
                $tab['id'] = 'latest_posts_custom3';
                break;
            case 19:
                $tab['title'] = $this->vbb->options['vietvbbtopstats_latest_posts_custom4_name'];
                $tab['id'] = 'latest_posts_custom4';
                break;
            case 20:
                $tab['title'] = $this->vbb->options['vietvbbtopstats_latest_posts_custom5_name'];
                $tab['id'] = 'latest_posts_custom5';
                break;
            case 21:
                $tab['title'] = $this->vbb->options['vietvbbtopstats_latest_posts_custom6_name'];
                $tab['id'] = 'latest_posts_custom6';
                break;
            case 22:
                $tab['title'] = $this->vbb->options['vietvbbtopstats_latest_posts_custom7_name'];
                $tab['id'] = 'latest_posts_custom7';
                break;
            case 23:
                $tab['title'] = $this->vbb->options['vietvbbtopstats_latest_posts_custom8_name'];
                $tab['id'] = 'latest_posts_custom8';
                break;
            case 24:
                $tab['title'] = $this->vbb->options['vietvbbtopstats_latest_posts_custom9_name'];
                $tab['id'] = 'latest_posts_custom9';
                break;
            case 30:
                $tab['title'] = $vbphrase['latest_blogs'];
                $tab['id'] = 'latest_blogs';
                break;
            case 31:
                $tab['title'] = $vbphrase['latest_comments'];
                $tab['id'] = 'latest_comments';
                break;
            case 32:
                $tab['title'] = $vbphrase['most_viewed_entrys'];
                $tab['id'] = 'most_viewed_entrys';
                break;
            case 33:
                $tab['title'] = $vbphrase['hottest_entrys'];
                $tab['id'] = 'hottest_entrys';
                break;
            case 34:
                $tab['title'] = $vbphrase['top_bloggers'];
                $tab['id'] = 'top_bloggers';
                break;
        }
    ...
    private function getMenuInfo($num)
    {
        ...
        switch ($this->vbb->options['vietvbbtopstats_switch_s' . $num]) {
            case 0:
                ...
                break;
            case 2:
                $menu['title'] = $vbphrase['newest_members'];
                $menu['value'] = 'newest_members';
                break;
            case 3:
                $menu['title'] = $vbphrase['top_posters'];
                $menu['value'] = 'top_posters';
                break;
            case 4:
                $menu['title'] = $vbphrase['top_starters'];
                $menu['value'] = 'top_starters';
                break;
            case 5:
                $menu['title'] = $vbphrase['top_referrers'];
                $menu['value'] = 'top_referrers';
                break;
            case 8:
                $menu['title'] = $vbphrase['top_reputation'];
                $menu['value'] = 'top_reputation';
                break;
            case 9:
                $menu['title'] = $vbphrase['thanked_members'];
                $menu['value'] = 'thanked_members';
                break;
            case 11:
                $menu['title'] = $vbphrase['top_infractions'];
                $menu['value'] = 'top_infractions';
                break;
            case 14:
                $menu['title'] = $vbphrase['top_credits'];
                $menu['value'] = 'top_credits';
                break;
            case 34:
                $menu['title'] = $vbphrase['top_bloggers'];
                $menu['value'] = 'top_bloggers';
                break;
        }
    ...
    private function latest_posts($custom = false)
    {
        ...
        while ($get_new_posts = $this->db->fetch_array($query)) {
            $get_new_posts[username] = $get_new_posts[lastposter];
            $get_new_posts[userid] = $get_new_posts[lastposterid];
