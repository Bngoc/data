...
if ($_POST['do'] == 'postreply') {
    ...
    if (isset($_POST['fromquickreply'])) {    // Don't update Who's Online for Quick Replies since it will get stuck on that until the user goes somewhere else
...
if ($_POST['do'] == 'postreply') {
    ...
    if (sizeof($errors) > 0) {
        ...
        if ($vbulletin->GPC['ajax']) {
            ...
            if ($cms_redirect) {    /* This is a CMS comment. We got here by posting from an article etc. */
