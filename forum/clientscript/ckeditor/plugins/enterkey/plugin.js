...
(function () {
    ...
    CKEDITOR.plugins.enterkey =
    {
        ...
        enterBr: function (editor, mode, range, forceMode) {
            ...
            var element = (CKEDITOR.env.webkit || CKEDITOR.env.opera) && elementPath.lastElement && elementPath.lastElement.getAscendant('a', true);
            if (element && range.checkBoundaryOfElement(element, CKEDITOR.END) && element.getName() == 'a' && element.getAttribute('href') && element.getChildCount()) {
