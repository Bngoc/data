    ...
    CKEDITOR.plugins.add('vbundo',
        {
            ...
            init: function (editor) {
                ...
                editor.on('enhancedReady', function () {
                ...
                editor.on('beforeModeUnload', function () {
                    (editor.mode == 'wysiwyg' || editor.mode == 'enhancedsource') && undoManager.save(true);
                });

                // Make the undo manager available only in wysiwyg and enhancedsource mode.
                editor.on('mode', function () {
                    undoManager.enabled = editor.readOnly ? false : (editor.mode == 'wysiwyg' || editor.mode == 'enhancedsource');
                    undoManager.reset();
            ...
            if (bookmarksA || bookmarksB) {
                ...
                for (var i = 0; i < bookmarksA.length; i++) {
                    ...
                    if (
                        ...
                        bookmarkA.endOffset != bookmarkB.endOffset || !CKEDITOR.tools.arrayCompare(bookmarkA.start, bookmarkB.start) || !CKEDITOR.tools.arrayCompare(bookmarkA.end, bookmarkB.end)) {
                        return false;
                    }
                }
            }
