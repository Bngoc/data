...
if ($_POST['do'] == 'editorswitch') {
    ...
    if ($vbulletin->GPC['parsetype'] == 'announcement') {    // oh this is a kludge but there is no simple way to changing the bbcode parser from using global $post with announcements without changing function arguments
        $post = array(
