...
if (empty($_REQUEST['do']) OR $_REQUEST['do'] == 'global') {
    ...
    <tr valign="top" id="skimlinks_setup_head"<?php echo !empty($skimlinks_pub_id) ? ' style="display: none;"' : ''; ?>>
        <td class="thead" colspan="2"><?php echo $vbphrase['skimlinks_global_setup']; ?><span
                id="skim_setup_head"></span></td>
    </tr>

    <tr valign="top" id="skimlinks_setup"<?php echo !empty($skimlinks_pub_id) ? ' style="display: none;"' : ''; ?>>
        <td class="alt1 skimLinksInfo" colspan="2">

            <div id="skim_buttons">
                <?php echo $vbphrase['skimlinks_global_new_setup']; ?>
                <div style="text-align: center; margin: 25px 0;">
                    <input type="button" value="<?php echo $vbphrase['skimlinks_global_active_new_acc']; ?>"
                           onclick="skimShow('skim_form_register');" class="button" style="margin-right: 70px;"/>
                    <input type="button" value="<?php echo $vbphrase['skimlinks_global_ass_ext_acc']; ?>"
                           onclick="skimShow('skim_form_associate');" class="button" style="margin-left: 70px;"/>
                </div>
            </div>

            <div id="skim_form_register" style="display: none;">
                <div id="skim_form_register_form">
                    &lt;<a href="javascript:void();" onclick="skimBack('skim_form_register');"
                           style="color: #001F30;"><?php echo $vbphrase['skimlinks_global_back']; ?></a><br/><br/>
                    <table border="0" cellpadding="0" cellspacing="0" width="460" align="center">
                        <tr>
                            <td colspan="3">
                                <div style="font-size: 11px; margin-bottom: 15px;">
                                    ...
                                    <?php echo $vbphrase['skimlinks_global_is_free']; ?></div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" valign="bottom">
                                <strong><?php echo $vbphrase['skimlinks_global_website_info']; ?></strong></td>
                            <td align="right" valign="bottom">
                                <small><?php echo $vbphrase['skimlinks_global_all_req']; ?></small>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <div style="height: 1px; background-color: #001F30; margin-bottom: 8px;"></div>
                            </td>
                        </tr>
                        <tr id="skimr_name_error" style="display: none;">
                            <td colspan="2"></td>
                            <td style="color: #ff0000; font-size: 10px;"><?php echo $vbphrase['skimlinks_global_ness_acc']; ?></td>
                        </tr>
                        <tr>
                            <td width="165"><?php echo $vbphrase['skimlinks_global_name']; ?>:</td>
                            <td width="15"><span id="skimr_name_error_icon" style="display: none;"><img
                                        src="../images/misc/colorpicker_close.gif" style="border: 0;" alt=""/></span>
                            </td>
                            <td align="right" width="280" style="height: 26px;"><input type="text" id="skimr_name"
                                                                                       value="" class="bginput"
                                                                                       style="width: 280px;"/></td>
                        </tr>
                        <tr id="skimr_email_error" style="display: none;">
                            <td colspan="2"></td>
                            <td style="color: #ff0000; font-size: 10px;"><?php echo $vbphrase['skimlinks_global_valid_email']; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo $vbphrase['skimlinks_global_email']; ?>:</td>
                            <td><span id="skimr_email_error_icon" style="display: none;"><img
                                        src="../images/misc/colorpicker_close.gif" style="border: 0;" alt=""/></span>
                            </td>
                            <td align="right" style="height: 26px;"><input type="text" id="skimr_email"
                                                                           value="<?php echo $vbulletin->userinfo['email']; ?>"
                                                                           class="bginput" style="width: 280px;"/></td>
                        </tr>
                        <tr id="skimr_domain_error" style="display: none;">
                            <td colspan="2"></td>
                            <td style="color: #ff0000; font-size: 10px;"><?php echo $vbphrase['skimlinks_global_ness_acc']; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo $vbphrase['skimlinks_global_domain']; ?>:</td>
                            <td><span id="skimr_domain_error_icon" style="display: none;"><img
                                        src="../images/misc/colorpicker_close.gif" style="border: 0;" alt=""/></span>
                            </td>
                            <td align="right" style="height: 26px;"><input type="text" id="skimr_domain"
                                                                           value="<?php echo $skimlinks_forum_url; ?>"
                                                                           class="bginput" style="width: 280px;"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">&nbsp;</td>
                            <td>
                                <input type="button" value="<?php echo $vbphrase['skimlinks_global_next_step']; ?>"
                                       onclick="skimCheck('register');" class="button"/>
                                <a href="javascript:void();" onclick="skimBack('skim_form_register');"
                                   style="margin-left: 8px;">
                                    <small><?php echo $vbphrase['skimlinks_global_cancel']; ?></small>
                                </a>
                            </td>
                        </tr>
                    </table>
                ...
                <div id="skim_form_register_check" style="display: none">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="460" align="center">
                        <tr>
                            <td colspan="2">
                                <div style="font-size: 11px; margin-bottom: 15px;">
                                    ...
                                    <?php echo $vbphrase['skimlinks_global_confirm_note']; ?></div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><strong><?php echo $vbphrase['skimlinks_global_website_info']; ?></strong>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            <td align="right"><span id="skimr_load" style="display: none; margin-right: 8px;"><img
                                        src="../images/misc/progress.gif" style="border: 0;" alt=""/></span></td>
                            <td>
                                <input type="button" value="<?php echo $vbphrase['skimlinks_global_active_acc']; ?>"
                                       onclick="skimApiCall('register');" class="button"/>
                                <a href="javascript:void();" onclick="skimEdit('register');" style="margin-left: 8px;">
                                    <small><?php echo $vbphrase['skimlinks_global_edit_info']; ?></small>
                                </a>
                            </td>
                        </tr>
                    </table>
                ...
                <div id="skim_form_register_check_error" style="display: none">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="460" align="center">
                        <tr>
                            <td colspan="2">
                                <div style="font-size: 11px; margin-bottom: 15px;"><img
                                        src="../images/misc/colorpicker_close.gif" style="border: 0;"
                                        alt=""/><?php echo $vbphrase['skimlinks_global_active_fail']; ?></div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><strong><?php echo $vbphrase['skimlinks_global_website_info']; ?></strong>
                        ...
                        <tr>
                            <td colspan="3">
                                <div style="float: left; width: 15px; margin-top: 10px;"><img
                                        src="../images/misc/colorpicker_close.gif" style="border: 0;" alt=""/></div>
                                <small style="display: block; margin: 8px 0; float: right; width: 445px;"
                                       id="skimr_error"></small>
                        ...
                        <tr>
                            ...
                            <td>
                                <div id="reg_to_assoc_btn">
                                    <input type="button" value="<?php echo $vbphrase['skimlinks_global_ass_acc']; ?>"
                                           onclick="skimChange('register');" class="button"/>
                                    <a href="javascript:void();" onclick="skimEdit('register');"
                                       style="margin-left: 8px;">
                                        <small><?php echo $vbphrase['skimlinks_global_edit_info']; ?></small>
                                    </a>
                                </div>
                                <div id="reg_to_assoc_back"><a href="javascript:void();"
                                                               onclick="skimBack('skim_form_register');">
                                        <small><?php echo $vbphrase['skimlinks_global_return_to']; ?></small>
                                    </a><br/><br/></div>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="460" align="center">
                        <tr>
                            <td style="font-size: 11px;">
                                ...
                                <div style="text-align: center"><input type="submit" class="button"
                                                                       value="<?php echo $vbphrase['skimlinks_global_finish']; ?>"/>
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <div id="skim_form_associate" style="display: none;">
                <div id="skim_form_associate_form">
                    &lt;<a href="javascript:void();" onclick="skimBack('skim_form_associate');"
                           style="color: #001F30;"><?php echo $vbphrase['skimlinks_global_back']; ?></a><br/><br/>
                    <table border="0" cellpadding="0" cellspacing="0" width="460" align="center">
                        <tr>
                            <td colspan="3">
                                <div style="font-size: 11px; margin-bottom: 15px;">
                                    ...
                                    <?php echo $vbphrase['skimlinks_global_ass_note']; ?></div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <strong>Skimlinks <?php echo $vbphrase['skimlinks_global_acc_info']; ?></strong></td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <div style="height: 1px; background-color: #001F30; margin-bottom: 8px;"></div>
                        ...
                        <tr id="skima_email_error" style="display: none;">
                            <td colspan="2"></td>
                            <td style="color: #ff0000; font-size: 10px;"><?php echo $vbphrase['skimlinks_global_valid_email']; ?></td>
                        </tr>
                        <tr>
                            <td width="165"><?php echo $vbphrase['skimlinks_global_email']; ?>:</td>
                            <td width="15"><span id="skima_email_error_icon" style="display: none;"><img
                                        src="../images/misc/colorpicker_close.gif" style="border: 0;" alt=""/></span>
                            </td>
                            <td width="280" align="right" style="height: 26px;"><input type="text" id="skima_email"
                                                                                       value="<?php echo $vbulletin->userinfo['email']; ?>"
                                                                                       class="bginput"
                                                                                       style="width: 280px;"/></td>
                        </tr>
                        <tr id="skima_domain_error" style="display: none;">
                            <td colspan="2"></td>
                            <td style="color: #ff0000; font-size: 10px;"><?php echo $vbphrase['skimlinks_global_ness_ass']; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo $vbphrase['skimlinks_global_domain']; ?>:</td>
                            <td><span id="skima_domain_error_icon" style="display: none;"><img
                                        src="../images/misc/colorpicker_close.gif" style="border: 0;" alt=""/></span>
                            </td>
                            <td align="right" style="height: 26px;"><input type="text" id="skima_domain"
                                                                           value="<?php echo $skimlinks_forum_url; ?>"
                                                                           class="bginput" style="width: 280px;"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="button" value="<?php echo $vbphrase['skimlinks_global_next_step']; ?>"
                                       onclick="skimCheck('associate');" class="button"/>
                                <a href="javascript:void();" onclick="skimBack('skim_form_associate');"
                                   style="margin-left: 8px;">
                                    <small><?php echo $vbphrase['skimlinks_global_cancel']; ?></small>
                                </a>
                ...
                <div id="skim_form_associate_check" style="display: none">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="460" align="center">
                        <tr>
                            <td colspan="2">
                                <div style="font-size: 11px; margin-bottom: 15px;">
                                    ...
                                    <?php echo $vbphrase['skimlinks_global_confirm_ass']; ?></div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            <td align="right"><span id="skima_load" style="display: none; margin-right: 8px;"><img
                                        src="../images/misc/progress.gif" style="border: 0;" alt=""/></span></td>
                            <td>
                                <input type="button" value="<?php echo $vbphrase['skimlinks_global_ass_acc']; ?>"
                                       onclick="skimApiCall('associate');" class="button"/>
                                <a href="javascript:void();" onclick="skimEdit('associate');" style="margin-left: 8px;">
                                    <small><?php echo $vbphrase['skimlinks_global_edit_info']; ?></small>
                                </a>
                            </td>
                        </tr>
                ...
                <div id="skim_form_associate_check_error" style="display: none">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="460" align="center">
                        ...
                        <tr>
                            <td colspan="2">
                                <div style="height: 1px; background-color: #999; margin-bottom: 8px;"></div>
                            </td>
                        </tr>
                        <tr>
                            <td width="180" style="color: #999;"><?php echo $vbphrase['skimlinks_global_email']; ?>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div id="assoc_to_reg_btn">
                                    <input type="button" value="<?php echo $vbphrase['skimlinks_global_create_acc']; ?>"
                                           onclick="skimChange('associate');" class="button"/>
                                    <a href="javascript:void();" onclick="skimEdit('associate');"
                                       style="margin-left: 8px;">
                                        <small><?php echo $vbphrase['skimlinks_global_edit_info']; ?></small>
                                    </a>
                                </div>
                                <div id="assoc_to_reg_back"><a href="javascript:void();"
                                                               onclick="skimBack('skim_form_associate');">
                                        <small><?php echo $vbphrase['skimlinks_global_return_to']; ?></small>
                                    </a><br/><br/></div>
                            </td>
                        </tr>
...
if ($_REQUEST['do'] == 'advanced') {
    ...
    ?>
    <tr>
        <td <?php if (!version_compare(@$vbulletin->versionnumber, '3.8.0', '>=')) { ?>colspan="3"<?php } ?>
            class="thead"><?php echo $vbphrase['skimlinks_activate_products'] ?></td>
        <td class="thead" colspan="2"><span
                class="normal"><?php echo $vbphrase['skimlinks_for_visitors_in_these_usergroups'] ?></span></td>
        <?php if (version_compare(@$vbulletin->versionnumber, '3.8.0', '>=')) { ?>
            <td class="thead" colspan="2"><span
                    class="normal"><?php echo $vbphrase['skimlinks_in_posts_by_these_usergroups'] ?></span></td>
        <?php } ?>
    </tr>
    <tr align="center" class="alt2border">
        <th <?php if (!version_compare(@$vbulletin->versionnumber, '3.8.0', '>=')) { ?>colspan="3"<?php } ?>class="alt1"
            align="left"><?php echo $vbphrase['usergroup'] ?></th>
    ...
    <tr>
        <td class="alt1">
            <label><input type="radio" name="skimlinks_thread_age_limit_enable"
                          value="0" <?php echo $slAgeLimitChecked[0] ?> /> <?php echo $vbphrase['skimlinks_activate_in_all_threads'] ?>
            </label>
            <dl class="dep_group">
                <dt><label>
                        <input type="radio" name="skimlinks_thread_age_limit_enable" value="1" id="timeLimitLinks"
                               class="dep_ctrl" <?php echo $slAgeLimitChecked[1] ?> />
                        <?php echo $vbphrase['skimlinks_activate_in_only_threads_last_post_older_than'] ?>
                    </label></dt>
                <dd id="timeLimitLinks_deps"><label><input type="text" name="skimlinks_thread_age_limit"
                                                           class="bginput number"
                                                           value="<?php echo $slThreadDays ?>"/> <?php echo $vbphrase['skimlinks_days'] ?>
                    </label></dd>
            </dl>
        </td>
        <td class="alt2">
            <label><input type="radio" name="skimwords_thread_age_limit_enable"
                          value="0" <?php echo $swAgeLimitChecked[0] ?> /> <?php echo $vbphrase['skimlinks_activate_in_all_threads'] ?>
            </label>
            <dl class="dep_group">
                <dt><label>
                        <input type="radio" name="skimwords_thread_age_limit_enable" value="1" id="timeLimitWords"
                               class="dep_ctrl" <?php echo $swAgeLimitChecked[1] ?> />
                        <?php echo $vbphrase['skimlinks_activate_in_only_threads_last_post_older_than'] ?>
                    </label></dt>
                <dd id="timeLimitWords_deps"><label><input type="text" name="skimwords_thread_age_limit"
                                                           class="bginput number"
                                                           value="<?php echo $swThreadDays ?>"/> <?php echo $vbphrase['skimlinks_days'] ?>
                    </label></dd>
            </dl>
        </td>
    </tr>
