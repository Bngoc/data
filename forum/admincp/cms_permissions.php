...
?>
    <script type="text/javascript"
            src="../clientscript/vbulletin_ajax_htmlloader.js?v=<?php echo SIMPLE_VERSION; ?>"></script>
    <script type="text/javascript"
            src="../clientscript/vbulletin_cms_management.js?v=<?php echo $vbulletin->options['simpleversion']; ?>"></script>
    <script type="text/javascript"><!--
    ...
    <form name="cms_perm_data" id="cms_perm_data" method="post" target="_self" action="cms_permissions.php">
        <table class="tcat" width="90%" cellpadding="4" cellspacing="0" style="margin:auto;">
            <tr>
                <td>
                    <div
                        style="width:100%;position:relative;text-align:<?php echo vB_Template_Runtime::fetchStyleVar('right'); ?>;">
                        <input id="button_perms_save" type="submit"
                               value="<?php echo $vbphrase['save_permission_changes']; ?>"/>
        ...
        <div align="center" style="width:90%;margin:auto;overflow:auto;height:auto;" id="cmspermissions_edit">
            <input type="hidden" name="s"
                   value="<?php echo htmlspecialchars_uni($vbulletin->session->vars['sessionhash']); ?>"/>
    ...
    <br/>
    <div style="width:90%;text-align:<?php echo vB_Template_Runtime::fetchStyleVar('left'); ?>;margin:auto;"
         id="sections">
        <div>
