...
if ($_REQUEST['do'] == 'activity') {
    ...
    if (!empty($vbulletin->GPC['scope'])) { // we have a submitted form
        ...
        while ($stats = $db->fetch_array($statistics)) { // we will now have each days total of the type picked and we can sort through it
