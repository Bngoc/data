        ...
        case 'Question':
            ...
            <script type="text/javascript">
                function js_jump(id, obj) {
                    ...
                    switch (task) {
                        case 'modifyquestion':
                            window.location = "verify.php?<?php echo $vbulletin->session->vars['sessionurl_js']; ?>do=modifyquestion&questionid=" + id;
                            break;
                        case 'killquestion':
                            window.location = "verify.php?<?php echo $vbulletin->session->vars['sessionurl_js']; ?>do=removequestion&questionid=" + id;
                            break;
                        default:
                            return false;
                            break;
    ...
    if (!empty($vbulletin->GPC['questionid'])) {
        ...
        <script type="text/javascript">
            function js_jump(aid, qid, obj) {
                ...
                switch (task) {
                    case 'modifyanswer':
                        window.location = "verify.php?<?php echo $vbulletin->session->vars['sessionurl_js']; ?>do=modifyanswer&answerid=" + aid + "&questionid=" + qid;
                        break;
                    case 'killanswer':
                        window.location = "verify.php?<?php echo $vbulletin->session->vars['sessionurl_js']; ?>do=removeanswer&answerid=" + aid + "&questionid=" + qid;
                        break;
                    default:
                        return false;
                        break;
