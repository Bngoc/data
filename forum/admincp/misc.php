...
if ($_REQUEST['do'] == 'doindextypes') {
    ...
    if ($vbulletin->GPC['indextypes'] == 0) {
        ...
        } else { // or create a new one with all type that can be searched
...
if ($_REQUEST['do'] == 'buildstats') {
    ...
    if (empty($timestamp)) {
        ...
        if ($timestamp['start'] == 0 OR $timestamp['start'] < 915166800) { // no value found or its before 1999 lets just make it the year 2000
