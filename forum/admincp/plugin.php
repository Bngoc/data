    ...
    <script type="text/javascript">
        function js_page_jump(i, sid) {
            ...
            if (act != '') {
                switch (act) {
                    case 'productdisable':
                        page = "plugin.php?do=productdisable&productid=";
                        break;
                    case 'productenable':
                        page = "plugin.php?do=productenable&productid=";
                        break;
                    case 'productedit':
                        page = "plugin.php?do=productedit&productid=";
                        break;
                    case 'productversioncheck':
                        page = "plugin.php?do=productversioncheck&productid=";
                        break;
                    case 'productexport':
                        ...
                        return;
                    case 'productdelete':
                        page = "plugin.php?do=productdelete&productid=";
                        break;
                    default:
                        return;
                }
