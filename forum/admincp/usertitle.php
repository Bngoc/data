...
if ($_REQUEST['do'] == 'modify') {
    ...
    <script type="text/javascript">
        function js_usergroup_jump(usertitleid, obj) {
            ...
            switch (task) {
                case 'edit':
                    window.location = "usertitle.php?<?php echo $vbulletin->session->vars['sessionurl_js']; ?>do=edit&usertitleid=" + usertitleid;
                    break;
                case 'kill':
                    window.location = "usertitle.php?<?php echo $vbulletin->session->vars['sessionurl_js']; ?>do=remove&usertitleid=" + usertitleid;
                    break;
                default:
                    return false;
                    break;
