...
<table cellpadding="0" cellspacing="0" border="0" width="<?php echo $OUTERTABLEWIDTH; ?>" align="center">
        ...
        <script type="text/javascript">
            function js_usergroup_jump(userinfo) {
                ...
                if (value != "") {
                    switch (value) {
                        case 'edit':
                            page = "edit&u=" + userinfo;
                            break;
                        case 'kill':
                            page = "remove&u=" + userinfo;
                            break;
                        case 'access':
                            page = "editaccess&u=" + userinfo;
                            break;
                        default:
                            page = "emailpassword&u=" + userinfo + "&email=" + value;
                            break;
                    }
    ...
    if ($_REQUEST['do'] == 'pruneusers') {
        ...
        if ($vbulletin->GPC['daysprune']) {
            ...
            if ($daysprune < 0) { // if you have a negative number you're never going to find a value
                print_stop_message('no_users_matched_your_query');
            }
