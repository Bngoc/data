...
if ($_REQUEST['do'] == 'edit' OR $_REQUEST['do'] == 'add') {
    ...
    foreach ($stylecache AS $style) {
        ...
        $style_options[$masterset]["$style[styleid]"] = /*construct_depth_mark($style['depth'], '&nbsp; &nbsp; ') . ' ' .*/
            $style['title'];
...
if ($_REQUEST['do'] == 'locate') {
    ...
    foreach ($locgroups AS $locgroup) {
        ...
        <img src="../images/ads/locator/ad_<?php echo($locgroup['key']); ?>.jpg?v=<?php echo SIMPLE_VERSION; ?>"
             style="border: none" alt="<?php echo($locgroup['key']) ?>"/>
