    ...
    */
    ...
    if (!empty($groupids)) {
        ...
        foreach ($groups AS $group) {
            ...
            } else if (empty($memberships_source["$group[groupid]"])) { // Only the destination user is a member of the group
                $memberships_combined[] = $memberships_dest["$group[groupid]"];
                continue;
            } else { // Only the source user is a member of the group
...
if ($_REQUEST['do'] == 'pmuserstats') {
    ...
    <script type="text/javascript">
        function js_pm_jump(userid, username) {
            ...
            switch (value) {
                case 'pmstats':
                    page = "usertools.php?do=pmfolderstats&u=" + userid;
                    break;
                case 'profile':
                    page = "user.php?do=edit&u=" + userid;
                    break;
                case 'pmuser':
                    page = "../private.php?do=newpm&u=" + userid;
                    break;
                case 'delete':
                    page = "usertools.php?do=removepms&u=" + userid;
                    break;
            }
            if (page != '') {
