...
function displaytags()
{
    ...
    if ($db->num_rows($tags)) {
        ...
        <tr>
            <td colspan="<?php echo $column_count; ?>" align="center" class="tfoot">
                <select id="select_tags" name="do">
                    <option value="tagmerge"
                            id="select_tags_merge"><?php echo $vbphrase['merge_selected_synonym']; ?></option>
                    <option value="tagdopromote"
                            id="select_tags_delete"><?php echo $vbphrase['promote_synonyms_selected']; ?></option>
        ...
        <script type="text/javascript"
                src="../clientscript/vbulletin_inlinemod.js?v=<?php echo $vboptions[simpleversion]; ?>"></script>
        <script type="text/javascript">
            <!--
            ...
            function js_show_synlist(trigger, listid) {
                ...
                trigger.onclick = function () {
                    return js_hide_synlist(trigger, listid)
                };
            ...
            function js_hide_synlist(trigger, listid) {
                ...
                trigger.onclick = function () {
                    return js_show_synlist(trigger, listid)
                };
