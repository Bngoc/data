FadeGallery=function(a,d){
	...
	this.setup=function(){
		this.options={
			...
			delay:d!=undefined&&d.delay!=undefined?d.delay*1000:2*1000,
			...
			prev_btn:d!=undefined&&d.prev_btn!=undefined?d.prev_btn:undefined,play_backward:d!=undefined&&d.play_backward!=undefined?d.play_backward:false
		};
		this.list=a;this.list_items=this.list.find("> li");
