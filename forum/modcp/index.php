...
if ($_REQUEST['do'] == 'head') {
    ...
    <table border="0" width="100%" height="100%">
        <tr valign="middle">
            <td><b><?php echo $vbphrase['moderator_control_panel']; ?></b>
                (vBulletin <?php echo $vbulletin->versionnumber; ?>)
            </td>
...
?>
<div>
    <img src="../cpstyles/<?php echo $vbulletin->options['cpstylefolder']; ?>/cp_logo.gif" alt="" border="0" hspace="4"
         vspace="4"/><?php
