...
function verify_strike_status($username = '', $supress_error = false)
{
    ...
    if ($strikes['strikes'] >= 5 AND $strikes['lasttime'] > TIMENOW - 900) { //they've got it wrong 5 times or greater for any username at the moment
    ...
    } else if ($strikes['strikes'] > 5) { // a bit sneaky but at least it makes the error message look right
        $strikes['strikes'] = 5;
    }
