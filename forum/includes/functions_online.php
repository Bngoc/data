...
function construct_online_bit($userinfo, $doall = 0)
{
    ...
    if ($userinfo['badlocation'] == 1) { // User received 'no permissions screen'
        if (
    ...
    } else if ($userinfo['badlocation'] == 2) { // Forum is locked
        $show['lockedout'] = true;
    } else if ($userinfo['badlocation'] == 3) { // User received error screen
