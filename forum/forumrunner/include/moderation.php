    ...
    if ($_POST['do'] == 'domovethread') {
        ...
        switch ($method) {
            ...
            case 'move':
                ...
                } else {    // Bypass check since title wasn't modified
            ...
            case 'movered':
                ...
                if ($threadinfo['visible'] == 1) {    // Insert redirect for visible thread
                    ...
                    unset($redir);
                } else {    // leave no redirect for hidden or deleted threads
                    log_moderator_action($threadinfo, 'thread_moved_to_x', $destforuminfo['title']);
                }
