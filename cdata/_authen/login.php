...
<form name="" method="post" action="<?php echo PHP_SELF; ?>">
    ...
    <div class="login_info">
        <input placeholder="Account" name="Account" id="login_username" required autocomplete="off" type="text" maxlength="10"/>
        <div class="pad_2px"></div>
        <input placeholder="Password" name="Password" id="login_password" required autocomplete="off" type="password" maxlength="10"/>
    </div>
