<div class="rageFighter">
    ...
    <div class="contBox">
        <p>
            <b>Thiết Binh</b> thuộc hậu duệ của quân đoàn Royal Knights tại vương quốc Kalrutan, <b>Thiết Binh</b> đã
            thành công khi sử dụng chiến thuật dùng sức mạnh cơ thể làm điểm mạnh. Với lối di chuyển nhanh nhẹn và ra
            đòn bất ngờ, <b>Thiết Binh</b> luôn tạo cho đối phương rơi vào thế bị động không kịp trở tay và hạ gục đối
            phương một cách nhanh chóng bằng thân hình đồ sộ của mình. Ngoài ra nhân vật này cũng có khả năng tiêu diệt
            kẻ địch từ xa với sức sát thương lớn từ năng lượng bản thân.<br><br>
        ...
        <center>
            ...
            <div class="table_hasNoline_v2">
                <table class="tableGuide">
                    ...
                    <thead>
                    <tr>
                        <th scope="col">Điểm thưởng khi lên Level</th>
                        <th scope="col">Strength Bắt Đầu</th>
                        <th scope="col">Agility Bắt Đầu</th>
                        <th scope="col">Vitality Bắt Đầu</th>
                        <th scope="col">Energy Bắt Đầu</th>
                        <th scope="col">Máu / HP</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                ...
                <table class="tableGuide">
                    ...
                    <tr>
                        ...
                        <th scope="col">AG</th>
                        <th scope="col">SD</th>
                        <th scope="col">Máu khi lên Level</th>
                        <th scope="col">Mana khi lên Level</th>
                        <th scope="col">SD khi lên Level</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                ...
                <table class="tableGuide">
                    ...
                    <thead>
                    <tr>
                        <th scope="col" style="width:40%">Cách tính điểm Chiến Binh</th>
                        <th scope="col">Cách Tính Điểm</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td style="text-align:left;padding-left:20px">Sức sát thương cao nhất</td>
                        <td style="text-align:left;padding-left:20px"><span style="color:red">(</span>[(Sức mạnh ÷ 5) +
                            (Nội lực ÷ 12) + (30% dame vũ khí tay trái)] + [(Sức mạnh ÷ 5) + (Nội lực ÷ 12) + (30% dame
                            vũ khí tay phải)]<span style="color:red">)</span> ÷ 2
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left;padding-left:20px">Sức sát thương nhỏ nhất</td>
                        <td style="text-align:left;padding-left:20px">([(Sức mạnh ÷ 7) + (Nội lực ÷ 15) + (30% dame vũ
                            khí tay trái)] + [(Sức mạnh ÷ 7) + (Nội lực ÷ 15) + (30% dame vũ khí tay phải)]<span
                                style="color:red">)</span> ÷ 2
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left;padding-left:20px">Khả năng tấn công</td>
                        <td style="text-align:left;padding-left:20px">(Cấp độ * 5) + (Nhanh nhẹn * 2.5) + (Nội lực ÷ 6)
                            + (Năng lượng ÷ 4)
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left;padding-left:20px">Sức chống đỡ</td>
                        <td style="text-align:left;padding-left:20px">(Nhanh nhẹn ÷ 8) + Toàn bộ sức chống đỡ của bộ
                            giáp và khiên
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:left;padding-left:20px">Khả năng tránh đòn</td>
                        <td style="text-align:left;padding-left:20px">(Nhanh nhẹn ÷ 10) + Khả năng tránh đòn của bộ giáp
                            và khiên
                        </td>
                    </tr>
                    <tr>
        ...
        <ul>
            ...
            <li><img alt="" src="/public/images/guides/img_ragefighter_skills_increaseOfDefenseRate.jpg">
                <p><span><strong>Hộ thân (Increase of Defense rate) :</strong> Kỹ năng buff</span><img
                    ...
                    Kỹ năng này có thể áp dụng đối với toàn nhóm Party và rất có thể sự ra đời của Thiết binh, DK thuần
                    nhanh nhẹn hoặc DW Manashield sẽ không còn được trọng dụng.</p>
            </li>
        </ul>
    </div>
