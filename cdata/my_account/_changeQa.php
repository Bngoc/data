...
<form id="formChangeRegist" action="<?php echo PHP_SELF; ?>" method="POST">
    ...
    <table style="width: 100%" cellpadding="2">
            ...
            <tr>
                <td>Thay đổi</td>
                <td colspan=""><label for="radio1"><input  id="radio1" type="radio" name="cars"  <?php if ($tabActive == 'Q') echo 'checked'; ?> value="Q" /> Câu hỏi bí mật </label></td>
                <td><label for="radio2"><input id="radio2" type="radio" name="cars" <?php if ($tabActive == 'A') echo 'checked'; ?> value="A" /> Câu trả lại bí mật </label> </td>
            </tr>
