...
//    echo 'Errors: <ol>';
//    foreach ($errors_result as $result) echo "<li style='color: red; font-weight: bold;'>$result</li>";
//    echo '</ol><hr/>';
}
?>
    ...
    <form id="formRegist" action="<?php echo PHP_SELF; ?>" method="POST">
        ...
        <tr>
            <td colspan="3" class="pd-top20" style="text-align:center">
                ...
                <img style="cursor:pointer" onclick="document.getElementById('formRegist').reset();" border="0" src="<?php echo URL_PATH_IMG; ?>/cancel.png"
