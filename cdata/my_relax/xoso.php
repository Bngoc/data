...
?>
    ...
    <table class='sort-table' cellpadding='0' border='0' width="100%" ;>
        ...
        <tr align="middle">
            <td align="right" width="55%"><strong>Kết Quả Đề </strong><?php echo date('l, d-m-Y', $timesTampResult); ?>: </td>
            <td align="left"><div class="cRed pd-left15"><strong><?php echo $resultDe; ?></strong></div></td>
        </tr>
    </table>
    <center>
        <form action='<?php echo PHP_SELF; ?>' method='POST' id="from-playDe">
            ...
            <table width="100%" class="mg-top15" align="center">
                <tr>
                    ...
                    <td class="bizwebform_col_2"><input type='number' id="numberDe" name='numberDe' max="99" min="0" class="changeNumber bizwebform width90" required /></td>
                    <td class="bizwebform_col_3" align="left"></td>
                </tr>
                <tr>
                    <td class="bizwebform_col_1" align="right">Tiền đặt cược<span class="required">*</span></td>
                    <td class="bizwebform_col_2"><input type='number' id="" name='moneyVpDe' class="changeNumber bizwebform width90" required/></td>
    ...
    <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>
        <tr>
            <td align='left'>
                - Bạn hãy đặt tiền và ghi số để bắt đầu ghi đề.<br>
                - 1 Vpoint = 1* 70 Vpoint;<br>
                - Thời gian trả kết quả là <?php echo getoption('timeResultDe'); ?> ngày hôm sau.<br>
                - Số tiền tối thiểu nhận ghi đề <?php echo number_format(getoption('moneyMinDe'), 0, ',', '.'); ?> (Vpoint)
            </td>
        </tr>
    </table>
