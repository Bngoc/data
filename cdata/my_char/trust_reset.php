...
list($showchar, $options_rs_trust, $before_info_trust) = _GL('showchar, options_rs_trust, before_info_trust');
list($sub) = _GL('sub');
            ...
            <tr>
                <td colspan="3">
                    <table width="100%" border="0" cellpadding="3" cellspacing="1">
                        <tr>
                            <td align="center" colspan="2"><b>Điều kiện Reset ủy thác thường </b></td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <hr>
                        ...
                        <?php if ($before_info_trust) foreach ($before_info_trust as $ke => $val) {
                            if (isset($val[1]))
                                echo '<tr>
        ...
        <form action="<?php echo PHP_SELF; ?>" method="POST">
            ...
            <tr>
                <td colspan="3" style="text-align:center">
                    <input type="hidden" value="uythacreset" name="action_rsuythac"/>
...
if (getoption('user_rs_uythac')) { ?>
    <div class="sub_ranking">
        <table style="width: 100%" cellpadding="2">
            <tr>
                <td colspan="3" class="">CONFIG TRUST RESET<br/></td>
            </tr>
            <tr>
        ...
        <table id="tbl_ranking">
            <tr>
                ...
                <td align="center"><b>Chaos</b></td>
                <td align="center"><b>Create</b></td>
                <td align="center"><b>Blue</b></td>
            </tr>

            <?php if ($options_rs_trust) foreach ($options_rs_trust as $df => $fd) {
                if ($ok_loop) {
                    $lv_rs_f = $lv_rs_e;
                    $lv_rs_e = $fd['reset'];
                } else {
...
<?php } else {
    echo '<table style="width: 100%" cellpadding="2">
			<tr><td><b><font styles ="font-size:15px;" color="red">Hiện không sử dụng Reset ủy thác!</font></b></td></tr>
		</table>';
}