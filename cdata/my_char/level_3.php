        ...
        <tr>
            <td colspan="3">
                <table width="100%" border="0" cellpadding="3" cellspacing="1">
                    <tr>
                        <td align="center" colspan="2"><b>Điều kiện làm nhiệm vụ level 380 (Master)</b></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <hr>
...
<?php
echoFormVerifyChar(['action_level3' => '_level3'], 'Bạn có chắc có muốn làm nhiệm vụ (Master 380) cấp 3! \n Giá: ' . $configLevel3[2] . 'Vp');
?>
...
<em>
    <?php
    echo '<b>Phí: <b>' . number_format((float)($configLevel3[2]), 0, ",", ".") . ' Vpoint </b><br>';
    ?>
</em>
