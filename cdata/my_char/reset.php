        ...
        <tr>
            <td colspan="3">
                <table width="100%" border="0" cellpadding="3" cellspacing="1">
                    <tr>
                        <td align="center" colspan="100"><b>Điều kiện Reset </b></td>
                    </tr>
                    <tr>
                        <td colspan="100" class="pd-bottom5">
                            <hr>
                        </td>
                    </tr>
                    <?php if ($before_info_re) {
                        foreach ($before_info_re as $ke => $val) {
                            if (isset($val[1])) {
                                echo '<tr>
