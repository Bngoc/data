...
$configLevel1 = explode('|', getoption('configLevel'), 2);
?>
        ...
        <tr>
            <td colspan="3">
                <table width="100%" border="0" cellpadding="3" cellspacing="1">
                    <tr>
                        <td align="center" colspan="2"><b>Điều kiện làm nhiệm vụ (level 150) cấp 1</b></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <hr>
...
<?php
echoFormVerifyChar(['action_level1' => '_level1'], 'Bạn có chắc có muốn làm nhiệm vụ (level 150) cấp 1! \n Giá: ' . $configLevel1[0] . 'Vp');
?>
...
<em>
    <?php
    echo '<b>Phí: <b>' . number_format((float)($configLevel1[0]), 0, ",", ".") . ' Vpoint </b><br>';
    ?>
</em>
